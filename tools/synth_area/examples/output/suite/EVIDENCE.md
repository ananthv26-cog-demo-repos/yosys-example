...
| PASS | the Boolean graph and the ASAP7 netlist are proven to match the RTL | 46 proven, 3 bounded, 0 failed, 0 unproven pairs; 34 pair(s) settled by bounded check from reset, not by induction |
